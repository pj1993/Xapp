...
import com.jsycn.pj_project.widget.floating.util.SystemUtil
...
//                LogHelper.e(TAG, "activity = null")
    ...
    private fun getDokitRootContentView(activity: Activity?, decorView: FrameLayout): FrameLayout {
        var dokitRootView = decorView.findViewById<FrameLayout>(R.id.dokit_contentview_id)//已经添加过了就直接拿
        if (dokitRootView != null) {
            return dokitRootView
        }
        //创建一个id是dokit_contentview_id的frameLayout
