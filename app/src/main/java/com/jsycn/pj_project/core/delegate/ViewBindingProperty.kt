...
/**
 *@Description:https://mp.weixin.qq.com/s/E8v-8mVhc_REXCftNOZ7cg
 * 个人感觉使用起来怪怪的，像这种封装，用反射封装的使用起来更简洁一点，后续可以考虑替换为反射加属性代理结合
 *@Author: jsync
 *@CreateDate: 2021/6/9 15:41
 */
...
abstract class LifecycleViewBindingProperty<in R : Any, out V : ViewBinding>(
    ...
    class ClearOnDestroyLifecycleObserver(
